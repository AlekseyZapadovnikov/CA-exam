...
![](/fig/caches-everywhere-meme.png)
![](/fig/caches-everywhere.png)
...
![](/fig/cache-basic.png)
![](/fig/memory-direct-vs-via-cache.png)
...
![](/fig/cache-hit-and-cache-size.png)
...
![*Отображение кеша на память*](/fig/cache-basic.png)
...
![](/fig/cache-missrate.png)

</div><div class="col">

![](/fig/cache-set-associative.png)
...
![](/fig/cache-l1-unified.png) <!-- .element height="150px" -->
![](/fig/cache-l1-banked.png)  <!-- .element height="150px" -->
...
![](/fig/cache-inclusive-exclisive.png)
...
![](/fig/cache-coherency-generic.jpg)

</div><div class="col">

![](/fig/multicore-cache.png)
...
![](/fig/cache-coherence-directory.jpg)
...
![](/fig/cache-coherence-snooping.jpg)
...
![*Длительность перемножения матриц от их размера*](/fig/matrix-multiplication-diagram.png)
...
![](/fig/matrix-multiplication-diagram.png)
![](/fig/matrix-transponent.png)
...
![](/fig/matrix-mul-memory-access-pattern.png) <!-- .element: height="600px" -->
![](/fig/matrix-mul-time.png)                  <!-- .element: height="600px" -->
...
![](/fig/phantom-os-classical-program.png)

----

#### Маршрут работы приложения, если память персистентна

![](/fig/phantom-os-modern-process.png)    <!-- .element: height="600px" -->

----

#### PhantomOS

![](/fig/phantom-os.jpg) <!-- .element: height="300px" -->
