...
![](/fig/monkeyuser-final-patch.png) <!-- .element: height="250px" -->
![](/fig/gitflow.png) <!-- .element: height="250px" -->
...
![](/fig/hs-sw-traditional-design.jpg) <!-- .element: height="250px" -->
...
![](/fig/hs-sw-co-design.jpg)

</div></div>

![](/fig/ES-HW-SW-lifecycle.png) <!-- .element: height="200px" -->

----

### Hardware/Software CoDesign. <br/> Скорость разработки

![](/fig/hw-sw-codesign-time-save.png)
...
![](/fig/platform-based-design-only-watch.png) <!-- .element: height="250px" -->

</div></div>

На стадии утилизации:

![](/fig/model-process-computer-one-level.png) <!-- .element: height="150px" -->
...
![](/fig/fsm-example.webp)

</div><div class="col">

#### Автомат с магазинной памятью

![](/fig/pushdown-overview.png)
...
![](/fig/math-example.png)<!-- .element: height="550px" -->
...
![](/fig/moc-distrib-openmp.gif) <!-- .element: height="200px" -->
![](/fig/moc-distrib-iec-61499.png) <!-- .element: height="200px" -->

(1) Open Multi-Processing (OpenMP)
(2) IEC 61499

![](/fig/moc-distrib-labview.png) <!-- .element: height="200px" -->
![](/fig/moc-distrib-lingua-franca.png) <!-- .element: height="200px" -->
...
![](/fig/sw-xtuml-dev-process.png) <!-- .element: height="300px" -->
![](/fig/sw-xtuml-translation.png) <!-- .element: height="300px" -->

----

### xtUML. Models

![](/fig/sw-xtuml-general-models.png)
![](/fig/sw-xtuml-model.png)
