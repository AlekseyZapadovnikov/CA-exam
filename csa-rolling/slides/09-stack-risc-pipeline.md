...
![](/fig/proc-stack-arch-scheme-only.png) <!-- .element: height="350px" -->

![](/fig/proc-stack-classes.png) <!-- .element: height="250" -->
...
![](/fig/proc-stack-evaluation-example.png) <!-- .element: height="300" -->
...
![](/fig/cisc-risc-stack-meme.jpg) <!-- .element: height="300px" -->
...
![*GA144*](/fig/GA144.jpg) <!-- .element: height="500px" -->
...
![](/fig/dark-silicon.jpg)

----

#### Dark Silicon. Patterns

![](/fig/dark-silicon-patterns.jpg)

----

### Memory Wall. CPU vs. Memory Performance

![](/fig/memory-wall-cpu-vs-memory.png)
...
![](/fig/prod-task-pipelined.png) <!-- .element: height="300px" -->
![](/fig/proc-risc-pipeline-vs-non-pipeline.jpg) <!-- .element: height="300px" -->
...
![](/fig/proc-risc-pipeline.jpg) <!-- .element: height="350px" -->
...
![](/fig/pipeline-data-forwarding.png)
...
![](/fig/pipeline-data-forwarding-error.png)

![](/fig/pipeline-data-forwarding-with-bubble.png)
...
![](/fig/pipeline-control-hazard.webp)
...
![](/fig/branch-predictor-static.jpg)
...
![](/fig/branch-predictor-dynamic-scheme.png)                  <!-- .element: height="260px" -->
![](/fig/branch-predictor-dynamic-2-bit-saturation.png) <!-- .element: height="260px" -->

Счётчик с накоплением, 2-bit
![](/fig/pipeline-branch-prediction-2bit-saturating-counter.png)
...
![](/fig/branch-predictor-dynamic-two-level-scheme.png) <!-- .element: height="300px" -->
![](/fig/branch-predictor-dynamic-two-level.png)        <!-- .element: height="300px" -->
