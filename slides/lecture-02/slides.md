...
<!-- source-slide-deck: slides/02-system-and-architecture.md -->
...
![](../../assets/course-fig/HW-SW-support-cost.png)
...
![](../../assets/course-fig/information-systems-evolution-eras.png) <!-- .element height="80%" width="80%" -->
...
![](../../assets/course-fig/realtime.jpg)
...
![](../../assets/course-fig/CPS-elements-evolution.png)
...
![](../../assets/course-fig/se-domain.jpg)

</div><div class="col">

![](../../assets/course-fig/system-view-of-an-aircraft.png)
...
![](../../assets/course-fig/modeling-complex-system-composition.png)
...
![](../../assets/course-fig/system-internal-organisation.png) <!-- .element: height="500px" -->
...
![](../../assets/course-fig/iso-15926-pipe-temporal-parts.jpg)
![](../../assets/course-fig/space-time-map-of-the-chairman.png)
...
![](../../assets/course-fig/system-project-view.png)
...
![](../../assets/course-fig/operational-environment-and-enabling-systems.png)
...
![](../../assets/course-fig/system-life-cycle.png)
...
![](../../assets/course-fig/geek-and-poke-architecture.jpg)<!-- .element: height="600px" -->
...
![](../../assets/course-fig/v-model.png)

----

### Риск откладывания управления рисками

![](../../assets/course-fig/risk-of-delaying-risk-management.png)

----

### Эффект архитектурного проектирования

![](../../assets/course-fig/schedule-overrun-from-amount-of-design.png)
...
![](../../assets/course-fig/communication-problem-senior-and-junior.png)
...
![](../../assets/course-fig/communication-problem-senior-and-junior-detail.png)

----

### Постановка задачи нетехническим специалистом

![](../../assets/course-fig/communication-problem-manager-and-dev.png)
...
![](../../assets/course-fig/geek-and-poke-fail.png)<!-- .element: height="600px" -->
...
![](../../assets/course-fig/controller-right2left.png)

----

Подсказка:

![](../../assets/course-fig/controller-right2left-2.png)
...
![](../../assets/course-fig/angle-marks.png)

----

Подсказка:

![](../../assets/course-fig/angle-marks-2.png)
