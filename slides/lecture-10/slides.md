...
# lecture-10 — Control conflict. Ввод-вывод, ISA. Программный ввод-вывод

> Слайды импортированы из `csa-rolling`. Это исходный материал курса, не экзаменационный билет.

<!-- source-slide-deck: slides/10-io-pmio-mmio-polling.md -->
...
![](../../assets/course-fig/input-output-system-example.png) <!-- .element height="420px" -->
...
![](../../assets/course-fig/input-output-model.jpg) <!-- .element height="220px" -->
...
![](../../assets/course-fig/io-memory-mapped-vs-port-mapped.png) <!-- .element height="400px" -->
...
![_Memory-Mapped I/O_](../../assets/course-fig/memory-mapped-io.png)
...
![](../../assets/course-fig/io-devices.png)
...
![](../../assets/course-fig/keyboard-switch.png) <!-- .element height="260px" -->
...
![](../../assets/course-fig/io-switch-bouncy.png) <!-- .element height="250px" -->
...
![](../../assets/course-fig/io-spi-shift-register.jpg)
...
![](../../assets/course-fig/io-switch-fsm.png)
